...
win32 {
    DEPENDPATH += E:\kawamoto\_projects\Qt5\freeglut-2.8.1\include
    INCLUDEPATH += E:\kawamoto\_projects\Qt5\freeglut-2.8.1\include
    LIBS += -LE:\kawamoto\_projects\Qt5\freeglut-2.8.1\lib\x86\Debug -lfreeglut
